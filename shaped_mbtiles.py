...
def set_pause_action(action):
    """
    Set the pause action reference for the plugin.
    
    Args:
        action: QAction for the pause/resume button
    """
    global _pause_action
...
def cleanup_drawing_state():
    """
    Clean up any active drawing state when plugin is unloaded.
    """
    if _drawing_state['rubber_band']:
        _drawing_state['rubber_band'].reset(QgsWkbTypes.PolygonGeometry)
    _drawing_state['points'] = []
